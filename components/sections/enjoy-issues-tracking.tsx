...
export default function EnjoyIssueTracking() {
  return (
    <Features color="194,97,254" colorDark="53,42,79">
      {/* <Features.Title>Issue tracking you&apos;ll enjoy using</Features.Title> */}
      <Features.Main
        title={
          <>
            Issue tracking
      ...
      <Features.Cards
        features={[
          ...
          },
          {
            ...
            imageClassName: 'top-[45%] left-[12px] md:top-[34%] md:left-[24px] w-[110%]',
            title: 'Make it yours',
